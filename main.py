...
from modules.Regression.run_lightgbm_regression import run_lightgbm_regression
...
if st.sidebar.checkbox("Run LightGBM Regression"):
    run_lightgbm_regression(df)
